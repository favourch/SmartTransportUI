...
$('#cbutton').on('click', function() {
	...
	if(usertext!=="") {
		...
		msgtime.innerHTML = hour + ":" + minutes;
...
route = ["Directions from Yaba to Obalende",{"Route":{"Start":{"Name":"Yaba","Latitude":"6.512468","Longitude":"3.370186"},"End":{"Name":"Obalende","Latitude":"6.449596","Longitude":"3.407559"}},"Legs":[[{"Start":{"Name":"Yaba","Latitude":"6.512468","Longitude":"3.370186"},"End":{"Name":"Obalende Park","Latitude":"6.450294","Longitude":"3.408723"},"HeadSign":"Obalende Park","TravelTime":" 32 mins","Vehicle":{"Type":"Danfo","MinFare":"100"}},{"Start":{"Name":"Obalende Park","Latitude":"6.450294","Longitude":"3.408723"},"End":{"Name":"Obalende","Latitude":"6.449596","Longitude":"3.407559"},"Vehicle":{"Type":"Walk","MinFare":"0"}},{"Info":{"TravelTime":" 32 mins","MinFare":100,"MaxFare":100}}],[{"Start":{"Name":"Yaba","Latitude":"6.512468","Longitude":"3.370186"},"End":{"Name":"Makoko","Latitude":"6.493429","Longitude":"3.381388"},"HeadSign":"Lsdp Estate","TravelTime":" 12 mins","Vehicle":{"Type":"Danfo","MinFare":"70","MaxFare":"100"}},{"Start":{"Name":"Makoko","Latitude":"6.493429","Longitude":"3.381388"},"End":{"Name":"Sangrouse","Latitude":"6.450579","Longitude":"3.399566"},"HeadSign":"Cms central Park","TravelTime":" 24 mins","Vehicle":{"Type":"Danfo","MinFare":"70","MaxFare":"100"}},{"Start":{"Name":"Sangrouse","Latitude":"6.450579","Longitude":"3.399566"},"End":{"Name":"Obalende","Latitude":"6.449596","Longitude":"3.407559"},"HeadSign":"Obalende Park","TravelTime":" 4 mins","Vehicle":{"Type":"Keke Napep","MinFare":"30","MaxFare":"50"}},{"Info":{"TravelTime":" 40 mins","MinFare":170,"MaxFare":250}}]]},{"latitude":"6.512473","longitude":"3.370416","address":"Yaba"},{"latitude":"6.449630","longitude":"3.407253","address":"Obalende"},"Share these directions with a friend:  <a href='whatsapp:\/\/send?text=Checkout these directions from Lara: http:\/\/lara.ng\/?getdirections=72155'><div class='share wa'><\/div><\/a>  <a href='https:\/\/twitter.com\/intent\/tweet?text=Checkout these directions from Lara: &hashtags=lara.ng &url=http:\/\/lara.ng\/?getdirections=72155' target='_blank'><div class='share tw'><\/div><\/a> <a href='https:\/\/www.facebook.com\/sharer\/sharer.php?u=http:\/\/lara.ng\/?getdirections=72155' target='_blank'><div class='share fb'><\/div><\/a> <a href='http:\/\/lara.ng\/?getdirections=72155' target='_blank'><div class='share web'><\/div><\/a><br>Learn marketable skills that can help you build an income on <a href=\"http:\/\/convers-e.com\/rpdev\/getdeals\/2%3Fs=elearn\" target=\"_blank\">Elearn.ng<\/a>",{"departure_date":"July 31, 2017","departure_point":"Jibowu Bus Stop, Murtala Muhammed Way, Lagos, Nigeria","drop_off_point":"Lagos City Hall, Catholic Mission Street, Lagos, Nigeria","allow_smoking":"N","accept_luggage":"N","ac_available":"Y","ride_details":"Pickup times and points are flexible. I link Jibowu from Somolu through Morocco Road. The trip terminates on Catholic Mission Street. Trip routes are flexible too.","price":"250","departure_time":"06:30 AM","url":"gomyway.com\/ride-details-lagos-lagos-77476","car":"Nissan Sunny","trailer":"Share these directions with a friend:  <a href='whatsapp:\/\/send?text=Checkout these directions from Lara: http:\/\/lara.ng\/?getdirections=72155'><div class='share wa'><\/div><\/a>  <a href='https:\/\/twitter.com\/intent\/tweet?text=Checkout these directions from Lara: &hashtags=lara.ng &url=http:\/\/lara.ng\/?getdirections=72155' target='_blank'><div class='share tw'><\/div><\/a> <a href='https:\/\/www.facebook.com\/sharer\/sharer.php?u=http:\/\/lara.ng\/?getdirections=72155' target='_blank'><div class='share fb'><\/div><\/a> <a href='http:\/\/lara.ng\/?getdirections=72155' target='_blank'><div class='share web'><\/div><\/a><br>Earn up to 50% cashback and enjoy great discounts at your favorite stores with <a href=\"http:\/\/convers-e.com\/rpdev\/getdeals\/1%3Fs=jara\" target=\"_blank\">Jara.ng<\/a>"}];
function newDiv() {
...
function processQueryx() {
	...
	if (gotlocation == true) {
		query = { Query: usersinput, lat:latitude, lng:longitude, uid:userid };
		gotlocation = false;
...
var larapp = {
	...
	larastore: localforage.createInstance({name: "larastore"})
};



// Gets site's data and updates
larapp.getSite = function() {
	var url = '../lara.json';
	//check cache support
	if ('caches' in window) {
		caches.match(url).then(function(response) {
			if (response) {
				response.json().then(function(json) {
					...
					if (larapp.hasRequestPending) {
						//console.log('[App] Site Updated From Cache');
					}
				});
			}
		});
	}
	larapp.hasRequestPending = true;
	// Make the XHR to get the data, then update the card
	var request = new XMLHttpRequest();
	request.onreadystatechange = function() {
		if (request.readyState === XMLHttpRequest.DONE) {
			if (request.status === 200) {
				larapp.hasRequestPending = false;
//				console.log('[App] Site Updated From Network');
			}
		}
	};
	request.open('GET.html', url);
	request.send();
};
larapp.getSite();
